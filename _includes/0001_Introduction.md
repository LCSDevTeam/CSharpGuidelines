...
- Make sure there are always a few hard copies of the [Cheat Sheet](https://github.com/lcsdevteam/CSharpGuidelines/releases/latest) close at hand.
...
- Consider forking the [original sources](https://github.com/lcsdevteam/csharpguidelines) on [GitHub](https://github.com/) and create your own [internal](https://github.com/lcsdevteam/csharpguidelines/blob/master/LICENSE.md) version of the document.
...
This document has been compiled using many contributions from community members, blog posts, on-line discussions and two decades of developing in C#. If you have questions, comments or suggestions, just let me know by sending me an email at [entwicklung@lcs-schlieben.de](mailto:entwicklung@lcs-schlieben.de), [creating an issue](https://github.com/lcsdevteam/csharpguidelines/issues) or Pull Request on GitHub, ping me at [http://twitter.com/ddoomen](http://twitter.com/ddoomen) or join the [Gitter discussions](https://gitter.im/lcsdevteam/CSharpGuidelines). I will try to revise and republish this document with new insights, experiences and remarks on a regular basis.
...
Absolutely. The corresponding [license](https://github.com/lcsdevteam/CSharpGuidelines/blob/master/LICENSE.md) allows you to [fork](https://github.com/lcsdevteam/csharpguidelines/fork), adapt and distribute that modified version within your organization as long as you refer back to the original version here. It's not required, but you would make me a very happy man if you credit me as the original author. And if you have any great ideas, recommendations or corrections, either submit an issue, or even better, fork the repository and provide me with a pull request.
